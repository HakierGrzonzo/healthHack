...
/* tslint:disable */
/* eslint-disable */
export { ObservationClient } from "./ObservationClient";
...
export type { Observation_component } from "./models/Observation_component";
export type { Observation_referenceRange } from "./models/Observation_referenceRange";
export type { ObservationDefinition } from "./models/ObservationDefinition";
export type { ObservationDefinition_qualifiedInterval } from "./models/ObservationDefinition_qualifiedInterval";
export type { ObservationDefinition_quantitativeDetails } from "./models/ObservationDefinition_quantitativeDetails";
