...
export class ObservationService {
   ...
   * @throws ApiError
   */
  public postObservation(requestBody?: Observation): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public getObservation1(id: string): CancelablePromise<Observation> {
    return this.httpRequest.request({
      method: "GET",
      url: "/Observation/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public deleteObservation(id: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/Observation/{id}",
      path: {
