...
export class PatientService {
   ...
   * @throws ApiError
   */
  public postPatient(requestBody?: Patient): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public getPatient1(id: string): CancelablePromise<Patient> {
    return this.httpRequest.request({
      method: "GET",
      url: "/Patient/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public putPatient(id: string, requestBody?: Patient): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "PUT",
      url: "/Patient/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public deletePatient(id: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/Patient/{id}",
      path: {
